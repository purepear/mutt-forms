...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	exports.PugRegistry = exports.utils = exports.validators = exports.widgets = exports.fields = undefined;
	    ...
	    _createClass(Pug, [{
	            ...
	            if (options.hasOwnProperty('fieldsets')) {
	                ...
	                try {
	                    for (var _iterator = options.fieldsets[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                        ...
	                        if (fieldsetSpec.options && fieldsetSpec.options.label) {
	                            fieldsetLabel = fieldsetSpec.options.label;
	                        }

	                        var fieldset = _core.Fieldset.new(schema, options, fieldsetFields, 'pug-fieldset-' + fieldsetIndex, fieldsetLabel);
	        ...
	        */
	        ...
	        value: function populate(data) {
	            ...
	            try {
	                for (var _iterator3 = this.fieldsets[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	        ...
	        */
	        ...
	        value: function render() {
	            ...
	            return new Promise(function (resolve, reject) {
	                ...
	                try {
	                    for (var _iterator5 = _this.fieldsets[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
	                        var _fieldset2 = _step5.value;
	        ...
	        */
	        ...
	        value: function getFieldByPath(path) {
	            ...
	            try {
	                for (var _iterator11 = this.fieldsets[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
	                    var fieldset = _step11.value;
	    ...
	    _createClass(Fieldset, [{
	        ...
	        */
	        ...
	        value: function _new(schema) {
	            ...
	            var label = arguments.length <= 4 || arguments[4] === undefined ? null : arguments[4];
	            ...
	            try {
	                for (var _iterator10 = Object.keys(schema)[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	_registry2.default.registerWidget('text', TextInput);
	...
	*/
	...
	_registry2.default.registerWidget('textarea', TextAreaInput);
	...
	*/
	...
	_registry2.default.registerWidget('email', EmailInput);
	...
	*/
	...
	_registry2.default.registerWidget('hidden', HiddenInput);
	...
	*/
	...
	_registry2.default.registerWidget('password', PasswordInput);
	...
	*/
	...
	_registry2.default.registerWidget('display', DisplayWidget);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _boolean = __webpack_require__(10);
	...
	var _integer = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	var ArrayField = exports.ArrayField = function (_Field) {
	    ...
	    */
	    function ArrayField(_ref) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ArrayField).call(this, {
	            id: id,
	            name: name,
	            label: label,
	            initial: initial,
	    ...
	    */
	    ...
	    _createClass(ArrayField, [{
	        ...
	        value: function addSlot() {
	            var position = this.slots.length;
	            var fieldId = this.id + '_item_' + position;
	            var fieldName = this.name + '_' + position;
	            var field = this.constructor.new(fieldId, fieldName, this.itemSchema, this.itemOptions);
	        ...
	        */
	        ...
	        set: function set(value) {
	            ...
	            try {
	                for (var _iterator4 = fieldValueMap[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	                    var _step4$value = _slicedToArray(_step4.value, 2);

	                    var field = _step4$value[0];
	...
	_registry2.default.registerField('array', ArrayField);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	_registry2.default.registerWidget('array', ArrayInput);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	_registry2.default.registerField('boolean', BooleanField);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	_registry2.default.registerWidget('checkbox', CheckboxInput);
	...
	*/
	var ChoiceField = exports.ChoiceField = function (_Field) {
	    ...
	    function ChoiceField(_ref) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ChoiceField).call(this, {
	            id: id,
	            name: name,
	            label: label,
	            initial: initial,
	...
	_registry2.default.registerField('enum', ChoiceField);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _choice2 = __webpack_require__(14);
	...
	*/
	...
	_registry2.default.registerWidget('select', SelectInput);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var _numbers = __webpack_require__(16);
	...
	*/
	var IntegerField = exports.IntegerField = function (_Field) {
	    ...
	    function IntegerField(_ref) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(IntegerField).call(this, {
	            id: id,
	            name: name,
	            label: label,
	            initial: initial,
	...
	_registry2.default.registerField('integer', IntegerField);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	_registry2.default.registerWidget('number', NumberInput);
	...
	*/
	var ObjectField = exports.ObjectField = function (_Field) {
	    ...
	    function ObjectField(_ref) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ObjectField).call(this, {
	            id: id,
	            name: name,
	            label: label,
	            initial: initial,
	...
	_registry2.default.registerField('object', ObjectField);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	_registry2.default.registerWidget('object', ObjectInput);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	_registry2.default.registerField('string', StringField);
	_registry2.default.registerField('date', StringField);
	_registry2.default.registerField('datetime', StringField);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	_registry2.default.registerWidget('date', DateInput);
	...
	*/
	...
	_registry2.default.registerWidget('dateselect', DateSelectionInput);
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	_registry2.default.registerWidget('radio', RadioInput);
